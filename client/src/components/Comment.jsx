    ...
    <div className='flex p-4 border-b dark:border-gray-600 text-sm'>
        ...
        <div className="flex-1">
            <div className="flex items-center mb-1">
                <span className='font-bold mr-1 truncate text-sm'>{user ? `@${user.username}` : "Usuario no encontrado"}</span>
        ...
        {isEditing ? (
            ...
            (
                ...
                <div className='flex items-center pt-2 max-w-fit gap-2'>
                    <button type='button' onClick={() => handleLike(comment._id)} className={`text-gray-400 hover:text-blue-500 cursor-pointer 
                        ${
